...
#[derive(Default)]
pub struct NeoMesh2dRenderPlugin;
...
impl Plugin for NeoMesh2dRenderPlugin {
        ...
        let view_layout = render_device.create_bind_group_layout(
            ...
            &BindGroupLayoutEntries::with_indices(
                ...
                (
                    ...
                    (4, uniform_buffer::<GpuLights>(false)),
                ),
            ),
        );
...
pub fn prepare_mesh2d_view_bind_groups(
    ...
    let (Some(view_binding), Some(globals), Some(light_binding)) = (
